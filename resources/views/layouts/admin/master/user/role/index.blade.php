...
<script type="text/javascript">
    $(function() {
        ...
        $('#createBtn').click(function() {
            ...
            $('#ajaxForm').attr('action', "{{ route('admin.user-role.store') }}");
        ...
        $('body').on('click', '#editBtn', function() {
            var id = $(this).data('id');
            var geturl = "{{ route('admin.user-role.edit', ':id') }}";
            var puturl = "{{ route('admin.user-role.update', ':id') }}";
        ...
        $(document).on('click', '#deleteBtn', function() {
            var id = $(this).data('id');
            var url = "{{ route('admin.user-role.destroy', ':id') }}";
        ...
        $('#roles').on('change', function() {
            ...
            var geturl = "{{ route('admin.user-permission.edit', ':id') }}";
            var puturl = "{{ route('admin.user-permission.update', ':id') }}";
            geturl = geturl.replace(':id', id);
            puturl = puturl.replace(':id', id);
