...
@section('pagetitle', isset($pagetitle) ? $pagetitle : 'Daftar User')
@section('stylesheets')
                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title text-center pt-1">Daftar User</h3>
                        ...
                        <div class="card-body">
                            <table id="usertables" class="table table-bordered table-sm data-table">
                                <thead>
                                    <tr>
                                ...
                                <tbody id="usertables-table-body">
                                </tbody>
                            </table>
                        </div>
                    </div>
...
<script type="text/javascript">
    $(function() {
        ...
        $('#createBtn').click(function() {
            var geturl = "{{ route('admin.user-list.create') }}";
            $('#ajaxModal').modal('show');
            $('#formName').html('Tambah Header');
            $('#ajaxForm')[0].reset();
            $('#ajaxForm').attr('action', "{{ route('admin.user-list.store') }}");
        ...
        $('body').on('click', '#editBtn', function() {
            var id = $(this).data('id');
            var create = "{{ route('admin.user-list.create') }}";
            var geturl = "{{ route('admin.user-list.edit', ':id') }}";
            var puturl = "{{ route('admin.user-list.update', ':id') }}";
        ...
        $(document).on('click', '#deleteBtn', function() {
            var id = $(this).data('id');
            var url = "{{ route('admin.user-list.destroy', ':id') }}";
